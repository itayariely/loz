...
class CalendarsControllerTest < ActionController::TestCase
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post :create, calendar: { color: @calendar.color, description: @calendar.description, name: @calendar.name }
    end
  ...
  test "should update calendar" do
    patch :update, id: @calendar, calendar: { color: @calendar.color, description: @calendar.description, name: @calendar.name }
    assert_redirected_to calendar_path(assigns(:calendar))
  end
